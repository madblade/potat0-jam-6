...
import { BoxBufferGeometry, CylinderBufferGeometry, Euler, Group, Matrix4, Mesh, Quaternion, SphereBufferGeometry } from 'three';
    ...
    add: function(o, extra)
    {
        ...
        if (o.type === 'compound') {
            ...
            if (o.geometry) {
                ...
                if (o.geoRot) o.geometry.applyMatrix(new Matrix4().makeRotationFromEuler(new Euler().fromArray(root.vectorad(o.geoRot))));
                // scale only geometry
