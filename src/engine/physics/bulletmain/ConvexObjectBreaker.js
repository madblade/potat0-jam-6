...
extend(ConvexObjectBreaker.prototype, {
    ...
    prepareBreakableObject(object, mass, velocity, angularVelocity, breakable)
    {
        ...
        userData.mass = mass;
        userData.velocity = velocity !== undefined ? velocity.clone() : new Vector3();
        userData.angularVelocity = angularVelocity !== undefined ? angularVelocity.clone() : new Vector3();
    ...
    cutByPlane(object, plane, output)
    {
        ...
        if (!geometry) {
            console.log(object, 'no geometry ?');
            return 0;
        }
