...
Object.assign(Constraint.prototype, {
    ...
    add(o)
    {
        ...
        if (!map.has(o.b1) || !map.has(o.b2)) {
            console.log('! not find body');
            return;
        }
        ...
        switch (o.type) {
            ...
            case 'joint':
                n = 2;
                joint = new Ammo.btHingeConstraint(b1, b2, posA, posB, axeA, axeB, useA);
                break;
            case 'joint_hinge_ref':
                n = 2;
                joint = new Ammo.btHingeConstraint(b1, b2, formA, formB, useA);
                break;
            case 'joint_slider':
                n = 3;
                joint = new Ammo.btSliderConstraint(b1, b2, formA, formB, useA);
                break;
            case 'joint_conetwist':
                n = 4;
                joint = new Ammo.btConeTwistConstraint(b1, b2, formA, formB);
                break;
            case 'joint_dof':
                n = 5;
                joint = new Ammo.btGeneric6DofConstraint(b1, b2, formA, formB, useA);
                break;
            case 'joint_spring_dof':
                n = 6;
                joint = new Ammo.btGeneric6DofSpringConstraint(b1, b2, formA, formB, useA);
                break;
            case 'joint_fixe':
                n = 7;
                joint = new Ammo.btFixedConstraint(b1, b2, formA, formB);
                break;
