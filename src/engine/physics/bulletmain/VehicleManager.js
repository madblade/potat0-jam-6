...
Object.assign(VehicleManager.prototype, {
    ...
    add(o)
    {
        ...
        if (o.mesh) {
            ...
            mesh = new Mesh(o.geometry, o.material);
            root.extraGeo.push(o.geometry);
        } else {
            var g = new BufferGeometry().fromGeometry(new BoxGeometry(size[0], size[1], size[2]));//geo.box;
            g.translate(-o.masscenter[0], -o.masscenter[1], -o.masscenter[2]);
            root.extraGeo.push(g);
            mesh = new Mesh(g, root.mat.move);
        }

        if (o.debug && o.shape) {
            mesh = new Mesh(o.shape, root.mat.debug);
        }
